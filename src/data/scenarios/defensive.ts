...
export const DEFENSIVE_SCENARIOS: Scenario[] = [
  {
    ...
    animation: {
      ...
      freezeLine:
        "You're the D going back for that puck. What do you do?",
      narration:
  ...
  },
  {
    ...
    animation: {
      ...
      freezeLine:
        "You're the weak-side D and the puck is across the ice. What's your read?",
      narration:
  ...
  },
  {
    ...
    animation: {
      ...
      freezeLine:
        "You've got the puck and one beat to make a play. What is it?",
      narration:
  ...
  },
  {
    ...
    animation: {
      ...
      freezeLine: "You've got the net-front man. What's the play?",
      narration:
  ...
  },
  {
    ...
    animation: {
      ...
      freezeLine: 'Tap the spot on the ice where you need to be.',
      narration:
