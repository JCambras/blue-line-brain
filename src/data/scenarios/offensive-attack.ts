...
export const OFFENSIVE_ATTACK_SCENARIOS: Scenario[] = [
  // ---------- ROOKIE ----------
  {
    ...
    animation: {
      ...
      freezeLine: "You're the D joining the rush. Tap the ice you should fill.",
  ...
  },
  {
    ...
    animation: {
      ...
      freezeLine: 'The line is clogged. What do you do with the puck?',
  ...
  },
  {
    ...
    animation: {
      ...
      freezeLine: "You won the pinch. What's next?",
  ...
  },
  {
    ...
    animation: {
      ...
      freezeLine: "You're all alone on the wall. What's the play?",
  ...
  // ---------- VARSITY ----------
  {
    ...
    animation: {
      ...
      freezeLine: 'The D just slid. Shot or pass?',
  ...
  },
  {
    ...
    animation: {
      ...
      freezeLine: "You're the weak-side D at the point. Where do you go?",
  ...
  },
  {
    ...
    animation: {
      ...
      freezeLine: "You're the fourth man over the line. What's your move?",
  ...
  },
  {
    ...
    animation: {
      ...
      freezeLine: 'The win is on your stick. Shoot or settle?',
  ...
  // ---------- ELITE ----------
  {
    ...
    animation: {
      ...
      freezeLine: 'Pressure is coming. Force it or keep it alive?',
  ...
  },
  {
    ...
    animation: {
      ...
      freezeLine: "Everything in you wants to join. What's the right read?",
  ...
  },
  {
    ...
    animation: {
      ...
      freezeLine: 'The rebound is sitting. Do you go?',
