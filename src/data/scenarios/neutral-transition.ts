...
export const NEUTRAL_TRANSITION_SCENARIOS: Scenario[] = [
  // ---------------------------------------------------------- rookie
  {
    ...
    animation: {
      ...
      freezeLine:
        "You've got the puck at center with a man angling in. What's the play?",
      narration:
  ...
  },
  {
    ...
    animation: {
      ...
      freezeLine:
        "You've got the puck and a winger in stride. What do you do?",
      narration:
  ...
  },
  {
    ...
    animation: {
      ...
      freezeLine:
        "You're on the wall at your blue line with pressure. What's your out?",
      narration:
  ...
  },
  {
    ...
    animation: {
      ...
      freezeLine:
        "You're just shy of the red line with a checker closing. What do you do with it?",
      narration:
  ...
  // ---------------------------------------------------------- varsity
  {
    ...
    animation: {
      ...
      freezeLine: 'The trap is loaded on your side. Where does the puck go?',
      narration:
  ...
  },
  {
    ...
    animation: {
      ...
      freezeLine: "Their D is caught below you. What's the play?",
      narration:
  ...
  },
  {
    ...
    animation: {
      ...
      freezeLine: 'Your partner has the puck - tap the spot where you should be.',
      narration:
  ...
  },
  {
    ...
    animation: {
      ...
      freezeLine: "Rim coming to you, checker closing. What's your first touch?",
      narration:
  ...
  // ---------------------------------------------------------- elite
  {
    ...
    animation: {
      ...
      freezeLine: "Look at their bench side. You're the strong-side D - what do you do?",
      narration:
  ...
  },
  {
    ...
    animation: {
      ...
      freezeLine: "You're caught mid-change with fresh pressure coming. What's the play?",
      narration:
  ...
  },
  {
    ...
    animation: {
      ...
      freezeLine: 'One second before their trap sets. What do you do?',
      narration:
